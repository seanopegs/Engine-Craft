...
func _ready() -> void:
	...
	GameUI.paragraph(ui, "Evakuasi telah berakhir. Kalian masih di sini.", Rect2(92, 316, 650, 60), 21)
...
func _on_play() -> void:
	Global.enter_level(mini(Global.unlocked_level, Global.max_levels))
